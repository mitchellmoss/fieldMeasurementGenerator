import { TransformableSVG } from "svg-pathdata/lib/TransformableSVG";
...
export declare class SVGPathData extends TransformableSVG {
    ...
    encode(): string;
    getBounds(): import("svg-pathdata/lib/types").TransformFunction & {
        minX: number;
        maxX: number;
        minY: number;
        maxY: number;
...
export { encodeSVGPath } from "svg-pathdata/lib/SVGPathDataEncoder";
export { SVGPathDataParser } from "svg-pathdata/lib/SVGPathDataParser";
export { SVGPathDataTransformer } from "svg-pathdata/lib/SVGPathDataTransformer";
